def ver_si_es_primo(numero_ingresado):
    ...
    if numero_ingresado > 1:
        for numero in range(2,
                            numero_ingresado):  # Dividimos el número por todos los números entre 2 y el número ingresado menos 1
        ...
        raise Exception("No ingresó un número natural superior a 1")


# Defino una variable en la que voy a meter al número que estoy llamando
es_primo = input("Ingrese un número natural superior a 1: ")
