...
def suma_numeros_menores_x(numero):
    acumulador = 0
    for i in range(1,numero+1): #numero+1 para que incluye al ultimo
        if i%2==0 and not(i%4==0): #si el numero es divisor de 2, el residuo es 0, y no divisor de 4
            acumulador= acumulador + i #0+i y despues reemplaza a 0 por el proximo numero cuando se cumpla condicion de arriba
